...
public class send_data extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                System.err.println("Error en el Correo: "+ex.toString());
            }
            ...
            out.println("<p>Si desea más informacion acerca del curso, mande un e-mail a <a href=\"mailto:g_rico_c@hotmail.com?Subject=Dudas%20sobre%20el%20curso%20de%20Java\" target=\"_top\">g_rico_c@hotmail.com</a> </p>");
            out.println("<p>¡Siguenos en <a href=\"https://www.facebook.com/CentrodeAprendizajeDigital\" target=\"_blank\">facebook</a>!</p>");
